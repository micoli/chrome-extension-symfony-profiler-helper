...
import RequestHeaders from "@pages/shared/LogList/RequestHeaders";
import JsonDisplay from "@pages/shared/LogList/JsonDisplay";
import RequestDetail from "@pages/shared/LogList/RequestDetail";
import { SearchableRequestLog } from "@pages/shared";

const ExpandedRow = ({ record }: { record: SearchableRequestLog }) => {
  return (
